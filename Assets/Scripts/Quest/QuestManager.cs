...
/// <summary>
/// 저장된 퀘스트 데이터가 있을 시 게임을 이어서 재 실행 시 정확한 데이터가 노출될 수 있도록 하고
/// 레벨업, 씬 전환 등 이벤트에 해당(레벨제한, 플레이어 위치)되는 퀘스트의 진행을 도움
/// </summary>
public class QuestManager
{
    ...
    {
        // NPC가 Player와 대화할 때 진행 가능한 퀘스트가 존재한다면 Idle Dialogue 대신 퀘스트 진행 대화를 노출함
